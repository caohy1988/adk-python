...
```bash
pytest contributing/samples/workflows/authored_workflow_ca_demo/test_ca_demo_agent.py -q   # 11
```
...
tournament converges to `bar`. The fan-out and tournament scenarios execute
